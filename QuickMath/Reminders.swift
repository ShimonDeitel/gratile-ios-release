...
enum Reminders {
    private static let identifier = "gratile.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Time for your daily gratitude"
        content.body = "What is one good thing from today? Keep your streak alive."
